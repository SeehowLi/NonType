...
export const APP_REPO_URL = 'https://github.com/SeehowLi/NonType'
export const APP_LICENSE_URL = 'https://github.com/SeehowLi/NonType/blob/main/LICENSE'
